...
while (1)
      {
      lcd_clear();
      //set s2 and s3 to red
      PORTB.2 = 0;
      PORTB.4 = 0;   
      color[0] = d; 
      //set s2 and s3 to green
      PORTB.2 = 1;
      PORTB.4 = 1;   
      color[1] = d;   
      //set s2 and s3 to blue
      PORTB.2 = 0;
      PORTB.4 = 1;   
      color[2] = d;      
      //set s2 and s3 to clear
      PORTB.2 = 1;
      PORTB.4 = 0;   
      color[3] = d;
    
      sprintf(buffer,"RED=%d, GREEN=%d, BLUE=%d, CLEAR=%d",color[0],color[1],color[2],color[3]);
      lcd_puts(buffer) ;
      delay_ms(500);
      }
}
